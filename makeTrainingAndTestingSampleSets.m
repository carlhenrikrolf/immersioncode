function [trainSet, testSet, trainAnswers, testAnswers] = makeTrainingAndTestingSampleSets()
...
%% Parameters
imSize = [50,50];     % number of [rows, columns] for each samples, in pixels
...
[RTrainSet, RTestSet, LTrainSet, LTestSet] = createSampleSets(imSize, nSamples, D, T, L, dataType);
