...
function [RCrowdedTestSet, LCrowdedTestSet] = createOneCrowdedSampleSet(imSize,nSamples,D,T,L,dataType)
...
for i = 1:nSamples
    ...
    RCrowdedTestSet(:,:,i) = createCrowdedSample(imSize, vernierFilter, squareFilter, dataType);
    LCrowdedTestSet(:,:,i) = createCrowdedSample(imSize, fliplr(vernierFilter), squareFilter, dataType);
...
function sample = createCrowdedSample(imSize, vernierFilter, squareFilter, dataType)
